...
% TODO: Not atomic, consider w(v), r(), w(v'), r() with the `[DATA ...]`
% message as a result of the first r() being delayed and delivered *after* the
% DATA message of the second r(). TOB does not preserve causality, leads to
% 'regression' of value with multiple sequential reads.
